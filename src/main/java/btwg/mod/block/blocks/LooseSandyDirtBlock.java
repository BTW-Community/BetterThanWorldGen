...
public class LooseSandyDirtBlock extends FallingFullBlock {
    public LooseSandyDirtBlock(int id) {
        super(id, Material.ground);
        this.setHardness(0.5f);
        this.setShovelsEffectiveOn();
        this.setStepSound(BTWBlocks.dirtStepSound);
        this.setUnlocalizedName("btwg.loose_sandy_dirt");
        this.setTextureName("btwg:loose_sandy_dirt");
